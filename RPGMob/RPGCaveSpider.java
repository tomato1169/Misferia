...
public class RPGCaveSpider extends EntitySpider {
    ...
    public RPGCaveSpider(Location loc, int id, String number) throws SQLException {
        ...
        this.goalSelector.a(2, (PathfinderGoal)new PathfinderGoalMeleeAttack((EntityCreature)this, 1.6D, false));
    ...
    private void mobconfig(Location loc) {
        Spider z = (Spider)getBukkitEntity();
